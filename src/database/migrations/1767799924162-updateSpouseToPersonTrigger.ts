...
export class UpdateSpouseToPersonTrigger1767799924162 implements MigrationInterface {
            ...
            begin
                ...
                IF current_setting('session_replication_role') = 'origin' THEN
                    ...
                    ELSIF TG_OP = 'DELETE' THEN
						...
						SELECT id INTO new_person_id FROM beneficiaries.persons WHERE uuid_column = OLD.uuid_column;
						...
						DELETE FROM beneficiaries.person_affiliates
				       	WHERE kinship_type = 10
				        	AND person_id = new_person_id;
						-- Se elimina la persona
						DELETE FROM beneficiaries.persons WHERE id = new_person_id;
                    END IF;
